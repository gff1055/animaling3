...
<input type="text" id="name" name="name" value="hello"/><br><br>
<label for="email">Email:</label>
<input type="text"  id="email" name="email"/><br><br>
<label for="password">Senha</label>
<input type="password" id="password" name="password"/><br><br>
<label for="checkPassword">Conf. Senha</label>
<input type="password" id="checkPassword" name="checkPassword"/><br><br>
<label for="dateBirth">Data de nascimento</label>
<input type="text" id="dateBirth" name="dateBirth"/><br><br>
